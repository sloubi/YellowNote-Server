...
class RefreshTokenWithDevice implements OAuth2\GrantType\GrantTypeInterface
{
    ...
    public function createAccessToken(AccessTokenInterface $accessToken, $client_id, $user_id, $scope)
    {
        ...
        $device_id = $this->refreshToken['device_id'];
        $this->storage->assignDeviceToToken($token, $device_id);
